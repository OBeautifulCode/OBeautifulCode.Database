...
namespace OBeautifulCode.Libs.Database.Test
{
    ...
    public class DbHelperTest : IDisposable
    {
        ...
        {
            // Arrange
            string connectionString = string.Format("Provider=SQLNCLI11;Server={0};Database={1};Trusted_Connection=yes;User Id={2};Password={3}", Server, this.DatabaseName, UserId, Password);
        ...
        {
            return string.Format(@"Server={0};Database={1};User ID={2};Password={3}", Server, databaseName ?? "master", UserId, Password);
        }
